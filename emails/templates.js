...
module.exports = {
  ...
  activateTemplate: data => {
    return module.exports.emailTemplate(
      `<div class='title'>Hi ${data.name},</div>
        <p>Click the button below within the <strong>15 minutes</strong> to activate your account.</p>
        <div>
        <a href='http://localhost:3000/activate/${data.activation_token}'>
        ...
        <div>
        <a href='http://localhost:3000/activate/${data.activation_token}'>
        http://localhost:3000/activate/${data.activation_token}
        </a>
        </div>`
    )
  },
  ...
  forgotTemplate: data => {
    return module.exports.emailTemplate(
      `<div class='title'>Hi ${data.name},</div>
        <p>Click the button below within the <strong>15 minutes</strong> to reset your password.</p>
        <div>
        <a href='http://localhost:3000/reset/${data.activation_token}'>
        ...
        <div>
        <a href='http://localhost:3000/reset/${data.activation_token}'>
        http://localhost:3000/reset/${data.activation_token}
        </a>
        </div>`
    )
  },
